...
import { ChatType, MessageType, UserType } from "../types/chats_types"

export const playSound = function() {
  const audio = new Audio('/audio/mixkit-software-interface-start-2574.wav')
  audio.volume = 0.2
  audio.play()
}

export const createUser = (
  id: string, firstName: string, lastName: string, picture: string | null = null
): UserType => {
  return {
    id: id,
    firstName: firstName,
...
export const getChatUnsentMessages = (
  chatId: string,
  chatClientId: string | null = null,
...
export const deleteDuplicates = (
  sendingMessages: Array<MessageType>, existingMessages: Array<MessageType>
) => {
...
export const getPairChatByParticipantsId = (
